...
class Article(BaseModel):
    ...
    title = models.CharField(
        ...
        help_text=_("Title of the article (minimum 5 characters)"),
        db_index=True
    )
    content = models.TextField(
        validators=[MinLengthValidator(50)],
        help_text=_("Content of the article (minimum 50 characters)")
    )
    tags = models.CharField(
        max_length=500,
        blank=True,
        help_text=_("Comma-separated tags (maximum 500 characters)"),
        db_index=True
    )
